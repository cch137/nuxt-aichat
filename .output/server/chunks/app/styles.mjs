...
const styles = {
  "node_modules/nuxt/dist/app/entry.js": () => import('./_nuxt/entry-styles.65df71f5.mjs').then(interopDefault),
  "pages/index.vue": () => import('./_nuxt/index-styles.b0c235a2.mjs').then(interopDefault),
  ...
  "layouts/chat.vue": () => import('./_nuxt/chat-styles.0abd2dc1.mjs').then(interopDefault),

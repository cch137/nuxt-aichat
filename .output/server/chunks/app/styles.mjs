...
const styles = {
  "node_modules/nuxt/dist/app/entry.js": () => import('./_nuxt/entry-styles.0e75c1f2.mjs').then(interopDefault),
  ...
  "layouts/chat.vue": () => import('./_nuxt/chat-styles.d16c913c.mjs').then(interopDefault),

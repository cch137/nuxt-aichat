...
const styles = {
  "node_modules/nuxt/dist/app/entry.js": () => import('./_nuxt/entry-styles.04de5842.mjs').then(interopDefault),
  ...
  "layouts/chat.vue": () => import('./_nuxt/chat-styles.5f4a1985.mjs').then(interopDefault),

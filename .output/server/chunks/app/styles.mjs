...
const styles = {
  "node_modules/nuxt/dist/app/entry.js": () => import('./_nuxt/entry-styles.85f2b451.mjs').then(interopDefault),
  ...
  "layouts/chat.vue": () => import('./_nuxt/chat-styles.15e5d8ef.mjs').then(interopDefault),

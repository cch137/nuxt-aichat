...
const styles = {
  "node_modules/nuxt/dist/app/entry.js": () => import('./_nuxt/entry-styles.550afb79.mjs').then(interopDefault),
  ...
  "layouts/chat.vue": () => import('./_nuxt/chat-styles.f3e4e759.mjs').then(interopDefault),

...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "mt-8 flex-col gap-4 flex-center" }, _attrs))} data-v-fa5ffea5>`);
...
const ls = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-fa5ffea5"]]);

export { ls as default };
//# sourceMappingURL=ls-7017e533.mjs.map

...
import { u as useFormItem, a as useFormSize, b as useFormDisabled, E as ElInput, C as CHANGE_EVENT, I as INPUT_EVENT, U as UPDATE_MODEL_EVENT } from './index-c191d638.mjs';
import { b as buildProps, g as useLocale, e as isNumber, s as isUndefined, E as ElIcon, D as arrow_down_default, G as minus_default, H as arrow_up_default, I as plus_default, w as withInstall, a as useSizeProp, _ as _export_sfc$1 } from './index-d0f66181.mjs';
import { f as useNamespace, _ as _export_sfc, t as throwError, e as debugWarn, d as useState, g as useNuxtApp } from '../server.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "mt-8 flex-col gap-4 flex-center" }, _attrs))} data-v-e0a2e1e0><h1 class="m-0" data-v-e0a2e1e0>Determinant</h1><div class="px-4 w-full max-w-prose flex flex-col gap-4 justify-center" data-v-e0a2e1e0>`);
      ...
      _push(`<!--]--></div><div data-v-e0a2e1e0><div data-v-e0a2e1e0>Determinant: ${ssrInterpolate(unref(determinant))}</div></div><div class="pb-16" data-v-e0a2e1e0></div><div class="flex-center pb-16" data-v-e0a2e1e0>`);
...
const matrixCalculator = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-e0a2e1e0"]]);

export { matrixCalculator as default };
//# sourceMappingURL=matrix-calculator-6cfbc20d.mjs.map

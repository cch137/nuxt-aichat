...
import { defineComponent, computed, openBlock, createBlock, resolveDynamicComponent, normalizeClass, unref, normalizeStyle, withCtx, renderSlot, useSSRContext, ref, mergeProps, isRef, Fragment, renderList, createTextVNode, toDisplayString } from 'vue';
import { b as buildProps, s as isUndefined, w as withInstall, x as componentSizes, _ as _export_sfc$1 } from './index-036fcace.mjs';
import { a as useFormSize } from './index-fa6727cb.mjs';
import { g as useNamespace, _ as _export_sfc, e as useState, r as random } from '../server.mjs';
...
var Text = /* @__PURE__ */ _export_sfc$1(_sfc_main$1, [["__file", "/home/runner/work/element-plus/element-plus/packages/components/text/src/text.vue"]]);
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "mt-8 flex-col gap-4 flex-center" }, _attrs))} data-v-88d5053c><h1 class="m-0" data-v-88d5053c>LS</h1><div class="px-4 w-full max-w-prose flex flex-col gap-4 justify-center" data-v-88d5053c>`);
      ...
      _push(`<div class="pb-16" data-v-88d5053c><!--[-->`);
      ssrRenderList(unref(lsTree), (chap) => {
        _push(`<details data-v-88d5053c><summary class="chapter-title" data-v-88d5053c>${ssrInterpolate(chap.chapter)}</summary><div class="flex flex-wrap gap-2 pl-4 pt-2 pb-4" data-v-88d5053c><!--[-->`);
      ...
      _push(`<!--]--></div><div class="flex-col flex-center pb-16" data-v-88d5053c><div data-v-88d5053c>`);
      _push(ssrRenderComponent(_component_el_text, { type: "info" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`\u63D0\u793A\uFF1A\u9EDE\u64CA\u4E0B\u8F09 (\u0421\u043A\u0430\u0447\u0430\u0442\u044C) \u53EF\u4EE5\u53D6\u5F97\u66F4\u6E05\u6670\u7684\u5716\u7247\u3002\u514D\u8CAC\u8072\u660E\uFF1A\u672C\u7AD9\u975E\u4EE5\u4E0A\u6587\u4EF6\u4E4B\u6240\u6709\u8005\uFF0C\u8A2A\u5BA2\u82E5\u56E0\u8A2A\u554F\u975E\u672C\u7AD9\u9801\u9762\u6216\u8CC7\u6E90\u5C0E\u81F4\u4EFB\u4F55\u640D\u5931\uFF0C\u672C\u7AD9\u6982\u4E0D\u8CA0\u8CAC\u3002`);
          } else {
            return [
              createTextVNode("\u63D0\u793A\uFF1A\u9EDE\u64CA\u4E0B\u8F09 (\u0421\u043A\u0430\u0447\u0430\u0442\u044C) \u53EF\u4EE5\u53D6\u5F97\u66F4\u6E05\u6670\u7684\u5716\u7247\u3002\u514D\u8CAC\u8072\u660E\uFF1A\u672C\u7AD9\u975E\u4EE5\u4E0A\u6587\u4EF6\u4E4B\u6240\u6709\u8005\uFF0C\u8A2A\u5BA2\u82E5\u56E0\u8A2A\u554F\u975E\u672C\u7AD9\u9801\u9762\u6216\u8CC7\u6E90\u5C0E\u81F4\u4EFB\u4F55\u640D\u5931\uFF0C\u672C\u7AD9\u6982\u4E0D\u8CA0\u8CAC\u3002")
            ];
          }
        }),
        _: 1
      }, _parent));
      _push(`</div></div><div class="flex-center pb-16" data-v-88d5053c>`);
      _push(ssrRenderComponent(_component_el_link, {
        onClick: ($event) => back()
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
...
const ls = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-88d5053c"]]);

export { ls as default };
//# sourceMappingURL=ls-d9af332b.mjs.map

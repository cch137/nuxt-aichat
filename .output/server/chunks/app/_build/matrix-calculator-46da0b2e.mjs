...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "mt-8 flex-col gap-4 flex-center" }, _attrs))} data-v-2f977c5e><h1 class="m-0" data-v-2f977c5e>Determinant</h1><div class="px-4 w-full max-w-prose flex flex-col gap-4 justify-center" data-v-2f977c5e>`);
      ...
      _push(`<!--]--></div><div data-v-2f977c5e><div data-v-2f977c5e>Determinant: ${ssrInterpolate(unref(determinant))}</div></div><div class="pb-16" data-v-2f977c5e></div><div class="flex-center pb-16" data-v-2f977c5e>`);
...
const matrixCalculator = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-2f977c5e"]]);

export { matrixCalculator as default };
//# sourceMappingURL=matrix-calculator-46da0b2e.mjs.map

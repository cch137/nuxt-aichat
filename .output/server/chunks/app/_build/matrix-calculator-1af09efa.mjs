...
import { f as useNamespace, _ as _export_sfc, t as throwError, e as debugWarn, d as useState } from '../server.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "mt-8 flex-col gap-4 flex-center" }, _attrs))} data-v-9d2b136a><h1 class="m-0" data-v-9d2b136a>Determinant</h1><div class="px-4 w-full max-w-prose flex flex-col gap-4 justify-center" data-v-9d2b136a>`);
      ...
      _push(`<!--]--></div><div data-v-9d2b136a><div data-v-9d2b136a>Determinant: ${ssrInterpolate(unref(determinant))}</div></div><div class="pb-16" data-v-9d2b136a></div><div class="flex-center pb-16" data-v-9d2b136a>`);
...
const matrixCalculator = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-9d2b136a"]]);

export { matrixCalculator as default };
//# sourceMappingURL=matrix-calculator-1af09efa.mjs.map

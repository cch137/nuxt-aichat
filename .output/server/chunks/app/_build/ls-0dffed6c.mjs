...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    computed(() => (selectedFilename.value.split(" ").at(-1) || "").split(".json")[0]);
    ref([]);
    ref([]);
    ref(false);
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "mt-8 flex-col gap-4 flex-center" }, _attrs))} data-v-5a9ef8ff>`);
...
const ls = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-5a9ef8ff"]]);

export { ls as default };
//# sourceMappingURL=ls-0dffed6c.mjs.map

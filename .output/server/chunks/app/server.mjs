...
const appHead = { "meta": [{ "charset": "UTF-8" }, { "http-equiv": "X-UA-Compatible", "content": "IE=edge" }, { "name": "viewport", "content": "width=device-width,initial-scale=1,user-scalable=no" }, { "name": "author", "content": "Curva" }, { "name": "keywords", "content": "Curva" }, { "name": "description", "content": "Oh yeah! It's an AI chat robot!" }, { "property": "og:description", "content": "Oh yeah! It's an AI chat robot!" }, { "property": "og:type", "content": "website" }, { "property": "og:site_name", "content": "Curva" }, { "property": "og:image", "content": "https://voodex.netlify.app/bg/black-trianglify-3.png" }], "link": [], "style": [], "script": [], "noscript": [{ "innerHTML": "<strong>We're sorry but this website doesn't work properly without JavaScript enabled. Please enable it to continue.</strong>" }] };
...
const layouts = {
  chat: () => import('./_nuxt/chat-8cff0029.mjs').then((m) => m.default || m),
  default: () => import('./_nuxt/default-6cbbc9ce.mjs').then((m) => m.default || m)
};
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-component-3b115392.mjs').then((r) => r.default || r));
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/island-renderer-d9a7d515.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();

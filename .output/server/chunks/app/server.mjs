...
const _routes = [
  ...
  },
  {
    ...
    component: () => import('./_nuxt/_conv_-3cc930d7.mjs').then((m) => m.default || m)
  },
  {
    ...
    component: () => import('./_nuxt/index-3740fec8.mjs').then((m) => m.default || m)
  },
  {
  ...
  },
  {
    ...
    component: () => import('./_nuxt/login-dba988f7.mjs').then((m) => m.default || m)
  },
  {
    name: "perspective",
    path: "/perspective",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/perspective-6815387e.mjs').then((m) => m.default || m)
  },
  {
    ...
    component: () => import('./_nuxt/signup-1e6a3bc3.mjs').then((m) => m.default || m)
  }
];
...
const namedMiddleware = {
  chat: () => import('./_nuxt/chat-3b6b15c8.mjs'),
  "only-no-auth": () => import('./_nuxt/onlyNoAuth-bccaa95b.mjs')
};
...
export { _export_sfc as _, useHead as a, useState as b, createError as c, useNamespace as d, entry$1 as default, useId as e, debugWarn as f, useUniCookie as g, useLocale as h, useNuxtApp as i, defaultNamespace as j, namespaceContextKey as k, defineNuxtRouteMiddleware as l, navigateTo as n, throwError as t, useRouter as u };

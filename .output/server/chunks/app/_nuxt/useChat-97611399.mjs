import { u as useState, f as useUniCookie, g as useNuxtApp, h as useLocale, n as navigateTo, d as useId, t as throwError, b as useNamespace } from '../server.mjs';
import { ref, nextTick, watch, reactive, createApp, toRefs, isRef, defineComponent, h as h$1, Transition, withCtx, withDirectives, createVNode, vShow, isVNode, render, computed, resolveComponent, openBlock, createBlock, createElementVNode, normalizeClass, normalizeStyle, withModifiers, createElementBlock, resolveDynamicComponent, createCommentVNode, toDisplayString, withKeys, renderSlot, createTextVNode, onScopeDispose, provide, unref } from 'vue';
import { u as useTitle } from './useTitle-dc6f5342.mjs';
import sha3 from 'crypto-js/sha3.js';
import md5 from 'crypto-js/md5.js';
import { b as buildProps, d as definePropType, g as getStyle, a as addClass, r as removeClass, E as ElMessage, u as useGlobalComponentSettings, i as isUndefined, _ as _export_sfc, c as isElement, e as ElButton, f as ElInput, h as ElIcon, T as TypeComponents, j as TypeComponentsMap, k as componentSizes, l as hasClass, m as EVENT_CODE } from './index-e055d37d.mjs';
...
const checkTokenAndGetConversations = () => {
  return new Promise((resolve, reject) => {
    $fetch("/api/chat/check", { method: "POST" }).then((_conversations) => {
...
const createRequest = (() => {
  ...
  const getWebBrowsing = () => webBrowsingMode.value;
...
let chatLoadings = /* @__PURE__ */ new Set();
const clear = () => {
  conversations.value = [];
  messages.value = [];
  navigateTo("/c/");
...
function useChat() {
  ...
  const loadChat = async (conv, isNew = false) => {
    ...
    const chat = first && isNew ? new Promise((resolve) => resolve(navigateTo("/c/"))) : isNew ? new Promise((resolve) => resolve(null)) : _loadChat(conv);
    first = false;
  ...
  const renameConversation = (id, defaultName = "") => {
    ...
    ElMessageBox.prompt(_t("message.renameConvHint"), _t("message.setting"), {
      ...
      $fetch("/api/chat/conv", { method: "PUT", body: { id, name } }).then(async () => {
        ElMessage({
          type: "success",
...
//# sourceMappingURL=useChat-97611399.mjs.map

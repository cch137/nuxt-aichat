import { d as useState, j as useUniCookie, b as useLocale, n as navigateTo, k as useNuxtApp, i as useId, t as throwError, f as useNamespace } from '../server.mjs';
...
import qs from 'qs';
import { b as buildProps, d as definePropType, g as getStyle, a as addClass, r as removeClass, E as ElMessage, u as useGlobalComponentSettings, i as isUndefined, _ as _export_sfc, c as isElement, e as ElIcon, T as TypeComponents, f as TypeComponentsMap, h as componentSizes, j as hasClass, k as EVENT_CODE } from './index-5d71dbaa.mjs';
import { E as ElButton, a as ElInput } from './index-57c1ada1.mjs';
    ...
    $fetch("/api/curva/check", { method: "POST" }).then((_conversations) => {
      ...
      conversations.value = list.sort().map((id) => {
        ...
        return {
          ...
          mtime: ((_c = saved[id]) == null ? void 0 : _c.mtime) || 0
        };
...
function useChat() {
  ...
  const sendMessage = async (forceMessage, regenerateId) => {
    ...
    if (lastModifiedConv !== convId) {
      ...
      checkTokenAndGetConversations().then(() => {
        try {
          document.querySelector(".ConversationList").scrollTop = 0;
        } catch {
        }
      });
    }
  ...
  const regenerateMessage = async (message) => {
    ...
    const { Q, id } = message || messages.value.at(-1);
    sendMessage(Q || "", id);
  };
...
//# sourceMappingURL=useChat-17814581.mjs.map

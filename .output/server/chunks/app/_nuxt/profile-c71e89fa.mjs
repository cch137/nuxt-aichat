import { E as ElInput } from './index-97682a6c.mjs';
...
import { a as useLocale, b as useState, _ as _export_sfc } from '../server.mjs';
...
import { u as useAuth } from './useAuth-c7355f6f.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<h1>${ssrInterpolate(_ctx.$t("settings.appearance"))}</h1>`);
...
//# sourceMappingURL=profile-c71e89fa.mjs.map

...
const createRequest = (() => {
  ...
  const createBody = (message, model2, temperature2, t, tz, regenerateId) => {
    var _a, _b;
    ...
    return { conv, context: getContext(), prompt: message, model: model2, temperature: temperature2, t, tz, id: regenerateId };
  };
...
function useChat() {
  ...
  const renameConversation = (id, defaultName = "") => {
    ...
    ElMessageBox.prompt(_t("message.renameConvHint"), _t("message.setting"), {
      ...
      $fetch("/api/curva/conv", { method: "PUT", body: { id, name } }).then(async () => {
        ElMessage({
          type: "success",
...
//# sourceMappingURL=useChat-340d1d8f.mjs.map

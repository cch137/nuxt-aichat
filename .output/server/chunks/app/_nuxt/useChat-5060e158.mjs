import { b as useState, k as useUniCookie, g as useNuxtApp, a as useLocale, n as navigateTo, j as useId, t as throwError, f as useNamespace } from '../server.mjs';
import { ref, watch, computed, nextTick, reactive, createApp, toRefs, isRef, defineComponent, h as h$1, Transition, withCtx, withDirectives, createVNode, vShow, isVNode, render, resolveComponent, openBlock, createBlock, createElementVNode, normalizeClass, normalizeStyle, withModifiers, createElementBlock, resolveDynamicComponent, createCommentVNode, toDisplayString, withKeys, renderSlot, createTextVNode, onScopeDispose } from 'vue';
import { u as useTitle } from './useTitle-685fa114.mjs';
import sha3 from 'crypto-js/sha3.js';
import md5 from 'crypto-js/md5.js';
import qs from 'qs';
import { a as ElMessage, E as ElInput, b as EVENT_CODE } from './index-97682a6c.mjs';
import { E as ElButton } from './index-291077d7.mjs';
import { b as buildProps, d as definePropType, s as getStyle, t as addClass, x as removeClass, k as useGlobalComponentSettings, y as isUndefined, _ as _export_sfc, n as isElement, E as ElIcon, m as TypeComponents, T as TypeComponentsMap, z as hasClass } from './use-form-item-11e2a50a.mjs';
import { isString, isObject, hyphenate, hasOwn, isFunction, NOOP } from '@vue/shared';
import { E as ElFocusTrap, i as isValidComponentSize, g as getScrollBarWidth } from './focus-trap-9fc9448e.mjs';
...
const callEditMessageDialog = (message) => {
...
function focusEditMessageInput() {
  try {
    document.querySelector(".EditMessageInput textarea").focus();
  } catch {
  }
}
const focusInput = () => {
...
const checkTokenAndGetConversations = () => {
  return new Promise((resolve, reject) => {
    $fetch("/api/curva/check", { method: "POST" }).then((_conversations) => {
      ...
      const currentConvIdComputed2 = getCurrentConvId();
      if (lastModifiedConv != currentConvIdComputed2) {
        lastModifiedConv = currentConvIdComputed2;
      }
...
const createRequest = (() => {
  ...
  return async (message) => {
    ...
    try {
      const body = createBody(formattedMessages, model.value, temperature.value, t, tz, message == null ? void 0 : message.id);
...
const getCurrentConvName = () => {
  ...
  return ((_a = conversations.value.filter((conv) => conv.id === currConvId)[0]) == null ? void 0 : _a.name) || "";
};
...
function useChat() {
  ...
  const sendMessage = async (forceMessage, regenerateId) => {
    ...
    if (isAtBottom) {
      useScrollToBottom().finally(() => focusInput());
    }
...
//# sourceMappingURL=useChat-5060e158.mjs.map

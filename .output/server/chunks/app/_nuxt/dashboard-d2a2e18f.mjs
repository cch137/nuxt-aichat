import { defineComponent, ref, computed, watch, nextTick, provide, reactive, onUpdated, openBlock, createElementBlock, normalizeClass, unref, createElementVNode, normalizeStyle, createBlock, resolveDynamicComponent, withCtx, renderSlot, createCommentVNode, inject, mergeProps, createVNode, toRef, Teleport, Transition, withDirectives, vShow, readonly, toDisplayString, withModifiers, toRefs, getCurrentInstance, withKeys, isRef, Fragment, renderList, useSSRContext, cloneVNode, Text, Comment, shallowRef, triggerRef, toRaw, resolveComponent, resolveDirective, vModelText, createSlots } from 'vue';
import { NOOP, isObject, isFunction, toRawType, isString, isPromise, isArray } from '@vue/shared';
import { B as buildProp, b as buildProps, C as addUnit, w as withInstall, d as definePropType, D as formItemContextKey, F as isBoolean, e as useFormSize, E as ElIcon, G as close_default, i as iconPropType, g as circle_close_default, H as arrow_down_default, I as useLocale, p as withNoopInstall, a as useFormItem, c as useFormItemInputId, f as useFormDisabled, o as loading_default, _ as _export_sfc, j as isNumber, J as useZIndex, A as componentSizes, q as useDeprecated, K as componentSizeMap, n as isElement } from './use-form-item-11e2a50a.mjs';
import { E as ElFocusTrap, i as isValidComponentSize, s as scrollIntoView } from './focus-trap-9fc9448e.mjs';
import { b as EVENT_CODE, E as ElInput, U as UPDATE_MODEL_EVENT, C as CHANGE_EVENT, I as INPUT_EVENT, a as ElMessage, i as isKorean } from './index-97682a6c.mjs';
import { f as useNamespace, j as useId, e as debugWarn, b as useState, l as useGetDerivedNamespace, m as useIdInjection, t as throwError } from '../server.mjs';
import { useResizeObserver, useEventListener, isClient, isIOS, onClickOutside, tryOnScopeDispose, unrefElement } from '@vueuse/core';
import { placements, createPopper } from '@popperjs/core';
import { isUndefined, isEqual, get, debounce, fromPairs } from 'lodash-unified';
...
var ElPopperContent = /* @__PURE__ */ _export_sfc(_sfc_main$a, [["__file", "/home/runner/work/element-plus/element-plus/packages/components/popper/src/content.vue"]]);
...
var ElTooltipTrigger = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["__file", "/home/runner/work/element-plus/element-plus/packages/components/tooltip/src/trigger.vue"]]);
...
var ElTooltipContent = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["__file", "/home/runner/work/element-plus/element-plus/packages/components/tooltip/src/content.vue"]]);
          ...
          createVNode(ElTooltipContent, {
            ...
            default: withCtx(() => [
              renderSlot(_ctx.$slots, "content", {}, () => [
                ...
                }, null, 8, _hoisted_1$2)) : (openBlock(), createElementBlock("span", _hoisted_2$2, toDisplayString(_ctx.content), 1))
              ]),
...
var Tooltip = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["__file", "/home/runner/work/element-plus/element-plus/packages/components/tooltip/src/tooltip.vue"]]);
...
var Tag = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["__file", "/home/runner/work/element-plus/element-plus/packages/components/tag/src/tag.vue"]]);
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const searchEngineOptions = ref(["google", "duckduckgo", "all"]);
    function searchEngineOnchange(value) {
      $fetch("/api/admin/search-engine", { method: "POST", body: { value } }).then(() => ElMessage.success("Search engine has been changed.")).catch(() => ElMessage.error("Search engine change failed."));
    }
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "flex-col flex-center gap-2" }, _attrs))}><h1>Admin Dashboard | ${ssrInterpolate(unref(appName))}</h1><h2>Discord Bot</h2>`);
      _push(ssrRenderComponent(_component_el_switch, {
        modelValue: unref(dcBotConnected),
        "onUpdate:modelValue": ($event) => isRef(dcBotConnected) ? dcBotConnected.value = $event : null,
        onChange: ($event) => updateDcBotConnected(),
        loading: unref(dcBotConnectedIsLoading),
        size: "large"
      }, null, _parent));
      _push(`<h2>Search Engine</h2>`);
      _push(ssrRenderComponent(_component_el_select, {
        modelValue: unref(searchEngine),
        "onUpdate:modelValue": ($event) => isRef(searchEngine) ? searchEngine.value = $event : null,
        placeholder: "Select",
        onChange: (value) => searchEngineOnchange(value)
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<!--[-->`);
            ssrRenderList(unref(searchEngineOptions), (item) => {
            ...
            return [
              (openBlock(true), createBlock(Fragment, null, renderList(unref(searchEngineOptions), (item) => {
...
//# sourceMappingURL=dashboard-d2a2e18f.mjs.map

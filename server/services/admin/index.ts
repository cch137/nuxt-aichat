...
import search, { AvailableSearchEngine } from '~/server/services/webBrowsing/search'

class AdminConfig<T> {
  readonly name: string
  #value: T
  onchange?: (value: T) => void;
  #callOnchange = (value: T) => this.onchange ? this.onchange(value) : undefined
  get value () {
    return this.#value
  }
  set value (value: T) {
...
const searchEngineConfig = new AdminConfig<AvailableSearchEngine>('search-engine', 'google', (v) => {
  search.engine = v
})
